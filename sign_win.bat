...
cd ..
copy /b ..\mozilla-release\other-licenses\7zstub\firefox\7zSD.sfx + browser\installer\windows\instgen\app.tag + pkg_%lang%\installer.7z dist\install\sea\cliqz-%ff_exe%.%platform_prefix%.installer.exe
goto sign_installer
