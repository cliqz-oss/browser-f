...
RUN dpkg --add-architecture i386 && \
    apt-get update && \
    apt-get upgrade -y && \
    apt-get install -y libc6:i386 libncurses5:i386 libstdc++6:i386 lib32z1 git xz-utils curl wget unzip openjdk-8-jdk python-dev python-pip python-virtualenv mercurial && \
    apt-get clean -y && \
