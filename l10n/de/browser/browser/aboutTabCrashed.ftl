...
crashed-offer-help = So können wir dir helfen:
crashed-single-offer-help-message = Wähle "{ crashed-restore-tab-button }", um die Seite neu zu laden.
crashed-multiple-offer-help-message = Wähle "{ crashed-restore-tab-button }" oder "{ crashed-restore-all-button }", um die Seite bzw. alle Seiten neu zu laden.
crashed-request-help = Unterstütze uns!
...
crashed-send-report = Automatischen Absturzbericht an Cliqz senden, damit solche Probleme von uns behoben werden können.
crashed-comment =
...
crashed-email-placeholder = Deine E-Mail-Adresse
crashed-email-me = Beim Vorliegen weiterer Informationen per E-Mail benachrichtigen
crashed-report-sent =  Absturzbericht bereits gesendet. Vielen Dank, dass du beim Verbessern von { -brand-short-name } hilfst!
