...
about-private-browsing-note = Vergessen Modus <strong>anonymisiert dich nicht</strong> im Internet. Dein Arbeitgeber oder dein Internetanbieter können weiterhin verfolgen, welche Seiten du besuchst.
...
about-private-browsing-search-banner-title = { $engineName } ist deine Standardsuchmaschine in Vergessen Fenstern
