...
about-httpsonly-title = { -brand-short-name } hat ein mögliches Sicherheitsproblem festgestellt
# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-explanation-unavailable = Sie surfen im Nur-HTTPS-Modus und es ist keine sichere HTTPS-Version von <em>{ $websiteUrl }</em> verfügbar.
