...
pw-empty-warning = Deine gespeicherten Passwörter, privaten Schlüssel und andere private Daten werden nicht geschützt.
pw-erased-ok = Du hast dein Master-Passwort gelöscht. { pw-empty-warning }
pw-not-wanted = Warnung! Du hast dich entschieden, kein Master-Passwort zu verwenden. { pw-empty-warning }
pw-change2empty-in-fips-mode = Du bist derzeit im FIPS-Modus. FIPS benötigt ein nicht leeres Master-Passwort.
...
master-password-admin = Ihr Administrator fordert, dass Sie ein Master-Passwort gesetzt haben, damit Sie Passwörter speichern können.
