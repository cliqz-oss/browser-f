...
otr-encryption-title = Bestätigte Verschlüsselung
...
view-fingerprint-button =
    .label = Fingerabdrücke von Kontakte verwalten
    .accesskey = F
...
otr-requireEncryption =
    .label = End-zu-Ende-Verschlüsselung für Gespräche mit einer Person verlangen
otr-verifyNudge =
