...
fips-nonempty-password-required = FIPS-Modus benötigt ein Master-Passwort für jedes Kryptographie-Modul. Bitte lege das Passwort fest, bevor du versuchst, den FIPS-Modus zu aktivieren.
unable-to-toggle-fips = Der FIPS-Modus für das Kryptographie-Modul konnte nicht geändert werden. Es wird empfohlen, dass du diese Anwendung bendest und neu startest.
load-pk11-module-file-picker-title = Wähle einen PKCS#11-Gerätetreiber zum Laden aus
